...
<div class="bg-white rounded-lg shadow">
	...
	<div class="overflow-auto max-h-[800px] bg-gray-100 p-4" id="resume-preview-container">
		<ResumePage>
			<!-- This is where the actual resume content goes -->
									...
									<div class="mb-4 break-inside-avoid">
										<div class="flex justify-between">
											...
											<span class="text-sm text-gray-600">
												{exp.startDate || 'Start Date'} - {exp.current
													? 'Present'
						...
						<div>
							...
							<div class="flex flex-wrap gap-2">
								{#each resumeData.skills as skill}
									{#if skill.name}
										<div
											class="bg-blue-50 border border-blue-200 rounded px-3 py-1 break-inside-avoid"
										>
					...
					<div class="flex flex-col md:flex-row gap-6">
						...
						<div class="md:w-1/3 bg-purple-100 p-6 rounded-lg">
							<div class="mb-6 text-center">
								...
								<p class="text-lg text-purple-600 mt-1">
									{resumeData.personal.title || 'Professional Title'}
								</p>
							</div>
							...
							<div class="mb-6 break-inside-avoid">
								<h2
									class="text-lg font-semibold text-purple-700 mb-2 border-b border-purple-300 pb-1"
								>
									Contact
								</h2>
						...
						<div class="md:w-2/3">
							{#if resumeData.personal.summary}
								<div class="mb-6">
									<h2
										class="text-xl font-semibold text-purple-800 mb-2 border-b border-purple-200 pb-1"
									>
										About Me
									</h2>
									<p class="text-gray-700">{resumeData.personal.summary}</p>
							...
							{#if resumeData.experience.some((exp) => exp.company || exp.position)}
								<div class="mb-6">
									<h2
										class="text-xl font-semibold text-purple-800 mb-3 border-b border-purple-200 pb-1"
									>
										Experience
									</h2>
									{#each resumeData.experience as exp}
										{#if exp.company || exp.position}
											<div class="mb-4 relative pl-6 break-inside-avoid">
					...
					{#if resumeData.skills.some((skill) => skill.name)}
						<div>
							...
							<div class="flex flex-wrap gap-2">
								{#each resumeData.skills as skill}
									{#if skill.name}
										<span class="bg-gray-100 px-3 py-1 rounded break-inside-avoid"
											>{skill.name}</span
										>
									{/if}
								{/each}
					...
					<div class="border-t-8 border-gray-800">
						...
						<div class="grid grid-cols-3 gap-6 mt-6">
							...
							<div class="col-span-3 md:col-span-1">
								<div class="mb-6 break-inside-avoid">
									<h2 class="text-lg font-semibold border-b border-gray-300 pb-2 mb-3">
										Contact Information
									</h2>
									<div class="space-y-2 text-sm">
										{#if resumeData.personal.email}
